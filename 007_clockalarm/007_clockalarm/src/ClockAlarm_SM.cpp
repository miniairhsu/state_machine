...
static QState Clock_Alarm_Clock(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case ALARM_SIG: {
            /*.${HSMs::Clock_Alarm::SM::Clock::ALARM::[me->alarm_status==ALARM_ON&&Clo~} */
...
static QState Clock_Alarm_Settings(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::ABORT} */
        case ABORT_SIG: {
...
static QState Clock_Alarm_ALARM_NOTIFY(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case TICK_SIG: {
            ...
            /*.${HSMs::Clock_Alarm::SM::ALARM_NOTIFY::TICK::[++me->alarm_timeout==2000]} */
            if (++me->alarm_timeout == 2000) {
                me->alarm_timeout = 0;
                status_ = Q_TRAN(&Clock_Alarm_Ticking);
            }
            else {
